<?php /* Smarty version 2.6.30, created on 2016-09-12 00:51:49
     ...
     <div class="container">
        <div class="fullscreen">
            <div class="row">
                ...
                <h2>Player 111</h2>
                <?php $_from = $this->_tpl_vars['cardss']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
